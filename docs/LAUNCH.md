...
|---|---|---|
| [Demo video](assets/flappy-demo.mp4) | 1920 × 1080, H.264, 30 video FPS | 30 seconds, original wall-clock speed |
| [GIF](assets/flappy-demo.gif) | 1040-pixel-wide animated GIF | 15 seconds, original wall-clock speed |
| [Maximum-speed video](assets/flappy-fast.mp4) | 1920 × 1080, H.264, 30 video FPS | 15 seconds, original speed, optimized live run |
| [Poster](assets/flappy-preview.png) | 1920 × 1080 PNG | Actual recorded state at approximately 75 seconds |
| [Source recording](../benchmarks/results/flappy-showcase.jsonl) | JSONL | Entire 100-second actual TTY run |
| [Provenance](assets/flappy-demo.json) | JSON | Source hash, model, timestamps and renderer hash |

Both Flappy recordings were made on an Apple M1: the showcase at a 12 FPS target (1,143 ticks, score 134, level 14) and the maximum-speed clip with `--optimize --max-speed` (**515 ticks at 25.71 ticks/second**). Both had zero deaths and zero interventions. [Flappy speed and stability](FLAPPY_BENCHMARKS.md).
